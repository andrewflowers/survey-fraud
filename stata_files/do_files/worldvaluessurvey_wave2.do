use "worldvaluessurvey_wave2.dta", clear

*record initial variable count, dataset name
local orig_dat_vars `c(k)'
local dataset "worldvaluessurvey_wave2"
...
forvalues i=1/18 {
	...
	*remove variables with >=10% missing data 
	foreach newvar of varlist v4 - v352 {
		quietly fre `newvar'
