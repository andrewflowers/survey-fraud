use "survey_data_files/worldvaluessurvey_wave6.dta", clear

*record initial variable count, dataset name
local orig_dat_vars `c(k)'
local dataset "worldvaluessurvey_wave6"
...
forvalues i=1/60 {
	...
	*remove variables with >=10% missing data 
	foreach newvar of varlist V4 - V228K {
		quietly fre `newvar'
