use "worldvaluessurvey_wave4.dta", clear

*record initial variable count, dataset name
local orig_dat_vars `c(k)'
local dataset "worldvaluessurvey_wave4"
...
forvalues i=1/41 {
	...
	*remove variables with >=10% missing data 
	foreach newvar of varlist v4 - V222 {
		quietly fre `newvar'
