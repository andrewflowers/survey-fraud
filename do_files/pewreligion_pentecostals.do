...
forvalues i=1/10 {
	...
	*remove variables with >=10% missing data 
	foreach newvar of varlist satisfy - REL_JOB {
		quietly fre `newvar'
		if (`r(N_valid)'/`r(N)')<.9{
			 drop `newvar'
			}
